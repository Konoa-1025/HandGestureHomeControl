...
## Core
[application](Core/application.py) NO


[applicationState](Core/applicationState.py) NO


[commandProcessor](Core/commandProcessor.py) NO


[initializer](Core/initializer.py) OK


[shutdown](Core/shutdown.py) NO
